package com.porumb.postsspringhtmx.controller;

import com.porumb.postsspringhtmx.model.Status;
...
public class StatusController {
    ...
    public String getFeed(Model model) {
        // adding posts into the model
        // we'll return the first page, the first 9 element
